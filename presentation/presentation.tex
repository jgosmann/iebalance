...
\begin{frame} \frametitle{Neuron Input}
    \begin{center}
        \credit{\includegraphics[width=0.6\textwidth]{figures/signals}}{\textcite{Vogels:2011wr}}
    \end{center}
\end{frame}
...
\begin{frame} \frametitle{Excitatory Plasticity}
    ...
    \end{itemize}
    \begin{center}
        \includegraphics[width=\textwidth]{figures/exc-stdp-add-l2}
    \end{center}
\end{frame}
